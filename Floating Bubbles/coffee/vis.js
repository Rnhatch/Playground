...
BubbleChart = (function() {
    ...
    BubbleChart.prototype.create_nodes = function() {
        this.data.forEach(__bind(function(d) {
            ...
            node = {
                id: d.id,
                radius: this.radius_scale(parseInt(d.total_amount)),
    ...
    BubbleChart.prototype.display_by_year = function() {
        this.force.gravity(this.layout_gravity).charge(this.charge).friction(0.9).on("tick", __bind(function(e) {
            return this.circles.each(this.move_towards_year(e.alpha)).attr("cx", function(d) {
                return d.x;
            }).attr("cy", function(d) {
                return d.y;
            });
    ...
    BubbleChart.prototype.move_towards_year = function(alpha) {
        return __bind(function(d) {
            var target;
            target = this.year_centers[d.year];
    ...
    BubbleChart.prototype.display_years = function() {
        ...
        return years.enter().append("text").attr("class", "years").attr("x", __bind(function(d) {
            return years_x[d];
...
$(function() {
    ...
    root.display_year = __bind(function() {
